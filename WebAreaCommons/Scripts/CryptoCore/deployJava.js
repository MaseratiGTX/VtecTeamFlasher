var deployJava = {
    ...
    runApplet: function (appletContainerId, attributes, parameters, minimumVersion) {
        ...
        if (matchData != null) {
            ...
            if ((browser != '?') && ('Safari' != deployJava.browserName2)) {
                if (deployJava.versionCheck(minimumVersion + '+')) {
                    deployJava.writeAppletTag(appletContainerId, attributes, parameters);
    ...
    writeAppletTag: function (appletContainerId, attributes, parameters) {
        ...
        $('#' + appletContainerId).html(startApplet + '\n' + params + '\n' + endApplet);
    },
